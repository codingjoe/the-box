...
If you still want to use local storage for development or testing purposes, you can mount a volume to your web container by modifying the `volumes` section in the [`containers/compose.web.yml`](https://github.com/codingjoe/the-box/blob/main/containers/compose.web.yml) file.
