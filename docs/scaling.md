...
You can also limit the resources used by each service in your [`containers/compose.web.yml`](https://github.com/codingjoe/the-box/blob/main/containers/compose.web.yml) file. This allows you to control the amount of CPU and memory used by each service.
